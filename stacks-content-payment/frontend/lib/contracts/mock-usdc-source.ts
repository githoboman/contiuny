...
;; Mint tokens (Public for Testnet Faucet Mode)
;; Removed owner check to allow anyone to self-mint for testing
(define-public (mint (amount uint) (recipient principal))
  (begin
    ;; (asserts! (is-eq tx-sender contract-owner) err-owner-only) ;; Disabled for public faucet
